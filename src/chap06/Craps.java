...
public class Craps {
    // cria um gerador seguro de números aleatórios para uso no metodo rollDice
    ...
    public static void main(String[] args) {
        ...
        switch (sumOfDice) {
            ...
            default:    // não ganhou nem perdeu, portanto registra a pontuação
                gameStatus = Status.CONTINUE;   // o jogo noã terminou
    ...
    // lança os dados, calcula a some e exibe os resultados
